...
<div class="col-mb-6 offset-md-3">
    ...
    if (isset($_SESSION['user_name'])) {
        echo '&#10084; <a href="mis_viewprofile.php" class="">View Profile</a><br />';
        echo '&#10084; <a href="mis_editprofile.php" class="">Edit Profile</a><br />';
...
?>
    <div class="col-md-6 offset-md-3">
        ...
        <a href="}/mis_viewprofile.php?id=<?= $row['user_id']; ?>" class=""><?= $row['user_name']; ?></a>
    </div>
